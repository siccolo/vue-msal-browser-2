...
export default class msalPlugin extends msal.PublicClientApplication {
    ...
    postMSGraph(endpoint: string, accessToken: string, data: any, callback: any): Promise<any>;
    postMSGraphAsPromise(endpoint: string, accessToken: string, data: any): Promise<any>;
